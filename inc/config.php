...
$config['MOBILE_DOMAIN']='darongpack.com';

//又拍云
$config['STORAGE_SIZE']=100;   //储存空间大小，单位M
$config['UPYUN_SWITCH']=false; //是否又拍云
$config['UPYUN_BUCKET_NAME']='syhung'; //服务名
$config['UPYUN_KEY']='B511qhBtKNpcisduw3U/mhdCpfI='; //密钥
$config['UPYUN_DOMAIN']='syhung.test.upcdn.net/'; //域名
