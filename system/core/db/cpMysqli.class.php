...
class cpMysqli {
    ...
    public function select_db($dbname){
        return mysqli_select_db($this->_writeLink,$dbname);
    }
	...
	private  function _connect($is_master = true) {
		...
		foreach($db_all as $db) {
			$mysqli = @new mysqli($db['DB_HOST'], $db['DB_USER'], $db['DB_PWD'],'', $db['DB_PORT']);
